...
--diffusion_model_filename gpu3_skill_model_ARCLE_07.03_400__diffusion_prior_best.pt \
--q_checkpoint_dir /home/ubuntu/yunho/ldcq_arc/LDCQ_for_SOLAR/q_checkpoints/gpu3_07.03 \
